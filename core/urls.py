...
router.register(r'booking-slots-doctor', views.DoctorBookingDetailPerDayViewset, basename='booking-slots')
router.register(r'booking-of-patient', views.PatientBookingDetailViewset, basename='booking-of-patient')

urlpatterns = [
    path('', include(router.urls)),
    path('signup/', views.Signup.as_view()),
    path('login/', views.Login.as_view()),
    re_path(r'^activate_user/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]+)/$',
