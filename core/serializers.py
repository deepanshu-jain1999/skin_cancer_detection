...
from .models import User, Profile, Report, ReportImage, DoctorBookingDetailPerDay, PatientBookingDetail
...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = ['photo', 'date_of_birth', 'city', 'gender', 'qualification', 'registration_number']
...
class PatientBookingDetailSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        try:
            booking_slot_object = DoctorBookingDetailPerDay.objects.get(id=booking_slot.id)
