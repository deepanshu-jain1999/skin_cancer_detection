...
class UserAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
            'fields': ('username', 'email', 'first_name', 'last_name', 'is_active', 'password', 'verified')
        }),
        ('Information if doctor', {
            'classes': ('collapse',),
            'fields': ('is_doctor',)
        }),
    ...
    list_editable = ('verified', 'is_patient', 'is_doctor',)
    ordering = ('id',)
...
class ReportAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'patient', 'report_name',)
...
class PatientBookingDetailAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'patient', 'booking_slot', 'token_number',)
